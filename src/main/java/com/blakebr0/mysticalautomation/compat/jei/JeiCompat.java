...
public final class JeiCompat implements IModPlugin {
    public static final IRecipeHolderType<IEnchanterRecipe> ENCHANTER_RECIPE_TYPE = IRecipeHolderType.create(MysticalAgricultureAPI.resource("enchanter"));
    public static final IRecipeHolderType<IInfusionRecipe>  INFUSION_ALTAR_RECIPE_TYPE = IRecipeHolderType.create(MysticalAgricultureAPI.resource("infusion"));
    public static final IRecipeHolderType<IAwakeningRecipe> AWAKENING_ALTAR_RECIPE_TYPE = IRecipeHolderType.create(MysticalAgricultureAPI.resource("awakening"));
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addCraftingStation(INFUSION_ALTAR_RECIPE_TYPE, new ItemStack(ModBlocks.INFUSION_ALTARNATOR.get()));
        registration.addCraftingStation(AWAKENING_ALTAR_RECIPE_TYPE, new ItemStack(ModBlocks.AWAKENING_ALTARNATOR.get()));
    }
