...
public class InfuserScreen extends BaseContainerScreen<InfuserContainer> {
    private static final ResourceLocation BACKGROUND = MysticalAutomation.resource("textures/gui/infuser.png");
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ProgressArrowWidget(x + 126, y + 73, this.menu::getProgress, this.menu::getOperationTime));
    }
