...
public class CrafterScreen extends BaseContainerScreen<CrafterContainer> {
    public static final ResourceLocation BACKGROUND = MysticalAutomation.resource("textures/gui/crafter.png");
    ...
    protected void renderBg(GuiGraphics gfx, float partialTicks, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            GhostItemRenderer.renderItemIntoGui(stack, x + 8 + (i * 18), y + 101, this.minecraft.getItemRenderer());
        }
