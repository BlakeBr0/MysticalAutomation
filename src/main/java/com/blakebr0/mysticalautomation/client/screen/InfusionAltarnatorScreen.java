...
public class InfusionAltarnatorScreen extends BaseContainerScreen<InfusionAltarnatorContainer> {
    public static final Identifier BACKGROUND = MysticalAutomation.resource("textures/gui/infusion_altarnator.png");

    public InfusionAltarnatorScreen(InfusionAltarnatorContainer container, Inventory inv, Component title) {
    ...
    protected void extractLabels(GuiGraphicsExtractor gfx, int mouseX, int mouseY) {
        ...
        gfx.text(this.font, this.playerInventoryTitle, 17, (this.imageHeight - 96 + 2), -12566464, false);
    }
