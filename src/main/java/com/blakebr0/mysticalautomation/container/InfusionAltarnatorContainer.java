...
public class InfusionAltarnatorContainer extends BaseContainerMenu implements IFakeRecipeContainer {
    ...
    public InfusionAltarnatorContainer(int id, Inventory playerInventory, CItemStacksHandler inventory, CItemStacksHandler recipeInventory, MachineUpgradeItemStackHandler upgradeInventory, ContainerData data, BlockPos pos) {
    ...
    private void onRecipeChanged() {
        if (this.level instanceof ServerLevel serverLevel) {
            ...
            var recipe = serverLevel.recipeAccess().getRecipeFor(MysticalCompat.RecipeTypes.INFUSION.get(), input, this.level).map(RecipeHolder::value).orElse(null);
