<recipetype:mysticalautomation:farmer>.addRecipe("test_farmer_no_crux",
  <item:mysticalagriculture:prosperity_seed_base>, <item:mysticalagriculture:inferium_farmland>, <block:mysticalagriculture:inferium_crop>,
  {
...
<recipetype:mysticalautomation:farmer>.addRecipe("test_farmer_crux",
  <item:mysticalagriculture:prosperity_seed_base>, <item:mysticalagriculture:prudentium_farmland>, <item:minecraft:cobblestone>, <block:mysticalagriculture:inferium_crop>,
  {
    <item:minecraft:carrot>: 1.0 as float?,
    <item:minecraft:potato>: 0.25 as float?
  }
